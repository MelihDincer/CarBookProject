...
namespace CarBookProject.Application.Validators.ReviewValidators
{
    public class UpdateReviewValidator : AbstractValidator<UpdateReviewCommand>
    {
        public UpdateReviewValidator()
        {
            ...
            RuleFor(x => x.CustomerImage).NotEmpty().WithMessage("Lütfen müşteri görselini boş geçmeyiniz!").MinimumLength(10).WithMessage("Lütfen yorum kısmına en az 10 karakter veri girişi yapınız!").MaximumLength(200).WithMessage("Lütfen yorum kısmına en fazla 200 karakter veri girişi yapınız!");
        }
    }
}
